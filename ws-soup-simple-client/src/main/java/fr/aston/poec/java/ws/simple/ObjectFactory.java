 ...
 * generated in the fr.aston.poec.java.ws.simple package. 
...
public class ObjectFactory {
    ...
    private final static QName _CelsiusFahrenheit_QNAME = new QName("http://soap.ws.java.poec.aston.fr/", "celsiusFahrenheit");
    private final static QName _CelsiusFahrenheitResponse_QNAME = new QName("http://soap.ws.java.poec.aston.fr/", "celsiusFahrenheitResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fr.aston.poec.java.ws.simple
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.ws.java.poec.aston.fr/", name = "celsiusFahrenheit")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.ws.java.poec.aston.fr/", name = "celsiusFahrenheitResponse")
