...
public interface IConverter {
    ...
    @RequestWrapper(localName = "celsiusFahrenheit", targetNamespace = "http://soap.ws.java.formation.poec.aston.fr/", className = "fr.aston.poec.java.ws.CelsiusFahrenheit")
    @ResponseWrapper(localName = "celsiusFahrenheitResponse", targetNamespace = "http://soap.ws.java.formation.poec.aston.fr/", className = "fr.aston.poec.java.ws.CelsiusFahrenheitResponse")
